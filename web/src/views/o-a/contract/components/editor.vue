    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                first_party_phone: [{ required: true, pattern: /^\d{11,12}$/, message: '请输入正确的甲方联系电话' }],
                second_party: [
                ...
                second_party_phone: [{ required: true, pattern: /^\d{11,12}$/, message: '请输入正确的乙方联系电话' }],
                ower_phone: [{ required: true, pattern: /^\d{11,12}$/, message: '请输入正确的业主联系电话' }],

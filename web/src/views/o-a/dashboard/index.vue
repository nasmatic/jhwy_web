                    ...
                    <ul>
                        <li class="repair">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/order/repair">
                        ...
                        <li class="complain">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/order/complain">
                        ...
                        <li class="mission">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/mission/">{{ detail.mission_total }}项待处理</router-link>
                            </div>
                        </li>
                        <li class="refound">
                            <div class="card-title">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/refound/flow?tab=approver">
                        ...
                        <li class="leave">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/leave/flow?tab=approver">
                        ...
                        <li class="purchase">
                            ...
                            <div class="card-operate">
                                ...
                                <router-link v-else to="/o-a/material/flow?tab=approver">
                        ...
                        <Carousel :height="height" loop v-if="height > 0" autoplay :autoplay-speed="6000">
                            <CarouselItem v-for="item in detail.party" :key="item.id">
                                <div class="carousel-item" :style="`height: ${height}px`">
                                    <router-link :to="`/o-a/party/detail/${item.id}`">
                ...
                <Card dis-hover :bordered="false" class="carousel-card min-mt-16" title="行政通知">
                    <Carousel :height="height" loop v-if="height > 0" autoplay :autoplay-speed="6000">
                        <CarouselItem v-for="item in detail.inform" :key="item.id">
                            <div class="carousel-item" :style="`height: ${height}px`">
                                <router-link :to="`/o-a/inform/detail/${item.id}`">
                                    <img :src="ASSET_HOST + item.cover_img" />
                                    <div class="title" :title="item.title">
                                        {{ item.title }}
                                    </div>
                    ...
                    render: (h, p) =>
                        h(
                            'a',
                            {
                                on: {
                                    click: () => {
                                        this.$router.push(`/o-a/meeting/detail/${p.row.id}`);
                                    }
                                }
                            },
                            '查看'

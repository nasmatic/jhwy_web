<template>
    <section class="login">
        <div class="login-form">
            <div class="logo">
                <img src="../../../assets/jhwy.svg" alt="logo" class="img-logo" />
                <div class="title">
                    <img src="../../../assets/logo_txt_white_2.svg" alt="海门嘉海" class="text-logo" />
                    <!--                    <h1><a href="https://github.com/chowa/ejyy" target="_blank">HMJH开源产品</a></h1>-->
                </div>
            </div>

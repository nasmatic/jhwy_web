<template>
    <section :class="wrapperClasses">
        <div class="cw-layout-nav-inner-logo">
            <router-link to="/">
                <img src="../../../assets/jhwy.svg" class="logo-img" />
                <span v-show="!siderCollapsed">
                    <img src="../../../assets/logo_txt_white_2.svg" v-if="theme === 'dark'" class="logo-txt" />
                    <img src="../../../assets/logo_text_2.svg" v-else class="logo-txt" />
                </span>
            </router-link>
        </div>

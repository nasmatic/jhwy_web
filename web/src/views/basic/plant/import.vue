    ...
    <WaterMark class="building-import">
        ...
        <Card dis-hover :bordered="false">
            ...
            <div v-if="step === 0">
                ...
                <a :href="ASSET_HOST + '/pc/plant/template/绿植租赁模板.xlsx'" target="_blank">
            ...
            <Result title="数据导入成功" v-if="step === 2">
                ...
                <div slot="actions">
                    ...
                    <Button @click="goList" type="primary">查看绿植</Button>
                </div>
            </Result>
        </Card>
    </WaterMark>
...
const columns = [
    ...
    },
    {
        title: '租赁开始时间',
        minWidth: 100,
        render: (h, p) => h('span', p.row.rent_start)
    },
    {
        title: '计划归还时间',
        minWidth: 100,
        render: (h, p) => h('span', p.row.rent_end)
    },
    {
        title: '租赁人',
        minWidth: 140,
        ...
        submit() {
            ...
            Modal.confirm({
                ...
                onOk: () => {
                    ...
                    const data = {
                        community_id: this.postInfo.default_community_id,
                        Plants: this.rightData.map(item => {
                            const ret = { ...item };
                            delete item.error;

        ...
        <Card dis-hover :bordered="false" class="mt-16" v-if="detail.info.step >= 2" title="许可装修审批信息">
            <Row class="detail-row">
                ...
                <Col :lg="8" :sm="12" :xs="24">
                    ...
                    <div class="detail-content">
                        <router-link :to="`/o-a/hr/colleague/detail/${detail.agreeUserInfo.id}`">
        ...
        <Card dis-hover :bordered="false" class="mt-16" v-if="detail.info.step === 4" title="物业验收审批信息">
            <Row class="detail-row">
                ...
                <Col :lg="8" :sm="12" :xs="24">
                    ...
                    <div class="detail-content">
                        <router-link :to="`/o-a/hr/colleague/detail/${detail.confirmUserInfo.id}`">
        ...
        >
            <Row class="detail-row">
                ...
                <Col :lg="8" :sm="12" :xs="24">
                    ...
                    <div class="detail-content">
                        <router-link :to="`/o-a/hr/colleague/detail/${detail.reutrnUserInfo.id}`">

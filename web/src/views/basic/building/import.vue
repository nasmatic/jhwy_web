    ...
    <WaterMark class="building-import">
        ...
        <Card dis-hover :bordered="false">
            ...
            <div v-if="step === 0">
                ...
                <a :href="ASSET_HOST + '/pc/building/template/asset.xlsx'" target="_blank">
...
const columns = [
    ...
    },
    {
        title: '建筑面积',
        minWidth: 80,
        render: (h, p) => h('span', p.row.cleanType ? p.row.cleanType : '-')
    },
    {
        title: '业主姓名',
        minWidth: 80,
    ...
    },
    {
        title: '业主电话号码',
        minWidth: 100,
        render: (h, p) => h('span', p.row.needGlass ? p.row.needGlass : '-')
    }
];
